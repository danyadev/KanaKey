...
export const KATAKANA_ORDER = [
  'ス', 'キ', 'ー', 'バ', 'パ', 'ン', 'レ', 'ア', 'カ', 'ラ', 'シ', 'コ', 'テ', 'ト', 'イ', 'メ', 'ロ', 'ク', 'ニ', 'リ', 'ジ', 'ビ', 'ホ', 'エ', 'オ', 'ギ', 'ゲ', 'サ', 'タ', 'ツ', 'ド', 'ヒ', 'マ', 'ム', 'ャ',
  'ウ', 'ケ', 'セ', 'ソ', 'チ', 'ナ', 'ヌ', 'ネ', 'ノ', 'ハ', 'フ', 'ヘ', 'ミ', 'モ', 'ル', 'ヤ', 'ユ', 'ヨ', 'ワ', 'ヲ', 'ガ', 'グ', 'ゴ', 'ザ', 'ズ', 'ゼ', 'ゾ', 'ダ', 'ヂ', 'ヅ', 'デ', 'ブ', 'ベ', 'ボ', 'ピ', 'プ', 'ペ', 'ポ', 'ュ', 'ョ', 'ッ',
] as const
